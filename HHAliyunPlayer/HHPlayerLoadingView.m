...
NSNotificationName const HHVideoPlayerConfigurationsDidUpdateNotification = @"HHVideoPlayerConfigurationsDidUpdateNotification";

NS_ASSUME_NONNULL_BEGIN
@interface _HHRotatingAnimationView : UIView
...
@interface _HHRotatingAnimationView ()<CAAnimationDelegate>
...
@implementation _HHRotatingAnimationView
...
@interface HHPlayerLoadingView ()
@property (nonatomic, strong, readonly) UILabel *speedLabel;
@property (nonatomic, strong, readonly) _HHRotatingAnimationView *animationView;
@end

@implementation HHPlayerLoadingView
- (instancetype)initWithFrame:(CGRect)frame {
    self = [super initWithFrame:frame];
    if ( !self ) return nil;
    [self _setupView];
    [self _updateSettings];
    [NSNotificationCenter.defaultCenter addObserver:self selector:@selector(_updateSettings) name:HHVideoPlayerConfigurationsDidUpdateNotification object:nil];
    return self;
}
...
- (void)_setupView {
    ...
    _animationView = [[_HHRotatingAnimationView alloc] initWithFrame:CGRectZero];
...
- (void)_updateSettings {
    _animationView.lineColor = UIColor.whiteColor;
}
@end
