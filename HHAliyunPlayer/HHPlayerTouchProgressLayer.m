//
//  HHPlayerTouchProgressLayer.m
//  RenMinWenLv
//
//  Created by mac mini on 2022/3/1.
//

#import "HHPlayerTouchProgressLayer.h"
#import "HHPlayerUtil.h"

@implementation HHPlayerTouchProgressLayer
{
...
-(void)initBrightNessView
{
    ...
    //毛玻璃效果
    [_brightNessView addSubview:[HHPlayerUtil makeEffectViewWithFrame:_brightNessView.bounds stype:UIBlurEffectStyleExtraLight cornerRadius:10]];
...
-(void)initVolumeView
{
    ...
    [_volumeView addSubview:[HHPlayerUtil makeEffectViewWithFrame:_volumeView.bounds stype:UIBlurEffectStyleExtraLight cornerRadius:10]];
...
-(void)initPlayerTimeView
{
    ...
    [_playerTimeView addSubview:[HHPlayerUtil makeEffectViewWithFrame:_playerTimeView.bounds stype:UIBlurEffectStyleDark cornerRadius:_playerTimeView.bounds.size.height/2]];
...
-(void)initLoadingView
{
    ...
    [_loadingView addSubview:[HHPlayerUtil makeEffectViewWithFrame:_loadingView.bounds stype:UIBlurEffectStyleDark cornerRadius:10]];
...
-(void)initLockedView
{
    ...
    [_lockedView addSubview:[HHPlayerUtil makeEffectViewWithFrame:_lockedView.bounds stype:UIBlurEffectStyleDark cornerRadius:10]];
